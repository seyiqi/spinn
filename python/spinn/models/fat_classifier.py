...
def build_sentence_model(cls, vocab_size, seq_length, tokens, transitions,
    ...
    sentence_model = cls(
        ...
        enc_embedding_dim=FLAGS.enc_embedding_dim,
...
if __name__ == '__main__':
    ...
    gflags.DEFINE_enum("use_attention", "None",
                       ...
                       "")
    gflags.DEFINE_integer("enc_embedding_dim", 20, "")
    gflags.DEFINE_boolean("use_encoded_embeddings", False,
        "Use Bidirectional LSTM to encode raw embeddings")
