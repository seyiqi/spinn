...
\
 ...
 --semantic_classifier_keep_rate 0.803630161684 \
 --tracking_lstm_hidden_dim 90 \
 --num_sentence_pair_combination_layers 2 \
 --embedding_keep_rate 0.833035508008 \
 --learning_rate 0.000853806982531 \
 --enc_embedding_dim 280 \
 --l2_lambda 1.59707389797e-05 \
 --scheduled_sampling_exponent_base 0.999963972588 \
 --transition_cost_scale 1.49521184383 \
"
