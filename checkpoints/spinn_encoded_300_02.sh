...
MODEL_NAME="spinn_encoded_300_02"
...
\
 --semantic_classifier_keep_rate 0.906760397453 \
 --tracking_lstm_hidden_dim 47 \
 --num_sentence_pair_combination_layers 3 \
 --embedding_keep_rate 0.869523740833 \
 --learning_rate 0.000444404386964 \
 --l2_lambda 1.36245178698e-05 \
 --scheduled_sampling_exponent_base 0.999975856882 \
 --transition_cost_scale 1.35682201247 \
"
