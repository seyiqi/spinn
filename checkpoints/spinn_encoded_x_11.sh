...
\
 ...
 --semantic_classifier_keep_rate 0.93156188414 \
 --tracking_lstm_hidden_dim 50 \
 --num_sentence_pair_combination_layers 2 \
 --embedding_keep_rate 0.804779399954 \
 --learning_rate 0.00301476934634 \
 --enc_embedding_dim 168 \
 --l2_lambda 1.91746973103e-05 \
 --scheduled_sampling_exponent_base 0.999989638468 \
 --transition_cost_scale 2.14152917734 \
"
